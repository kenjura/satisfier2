    ...
    .map(
      (rawRecipe) =>
        new Recipe({
          ...
          inputQuantity1: Number(rawRecipe.item1Qty),
          inputPart2: Part.stub(rawRecipe.item2),
          inputQuantity2: Number(rawRecipe.item2Qty),
          inputPart3: Part.stub(rawRecipe.item3),
          inputQuantity3: Number(rawRecipe.item3Qty),
          inputPart4: Part.stub(rawRecipe.item4),
          inputQuantity4: Number(rawRecipe.item4Qty),
